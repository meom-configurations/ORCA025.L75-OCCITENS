MODULE ice_2
   ...
   CHARACTER(lc)         , PUBLIC ::   cn_icerst_in  = "restart_ice_in"   !: suffix of ice restart name (input)
   CHARACTER(lc)         , PUBLIC ::   cn_icerst_out = "restart_ice"      !: suffix of ice restart name (output)
