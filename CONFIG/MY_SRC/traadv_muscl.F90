...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: traadv_muscl.F90 3718 2012-11-30 15:15:07Z cetlod $ 
...
CONTAINS
   ...
   SUBROUTINE tra_adv_muscl( kt, kit000, cdtype, p2dt, pun, pvn, pwn, &
      ...
      REAL(wp), POINTER, DIMENSION(:,:,:) :: zslpx, zslpy, zwym
      INTEGER  ::   ierr
      !!----------------------------------------------------------------------
      !
      IF( nn_timing == 1 )  CALL timing_start('tra_adv_muscl')
      !
      CALL wrk_alloc( jpi, jpj, jpk, zslpx, zslpy ,zwym )
      !
      ...
      ENDDO
      !
      CALL wrk_dealloc( jpi, jpj, jpk, zslpx, zslpy, zwym )
      !
