...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: traadv_qck.F90 3625 2012-11-21 13:19:18Z acc $
...
CONTAINS
   ...
   SUBROUTINE tra_adv_qck_j( kt, cdtype, p2dt, pvn,                &
      ...
      REAL(wp) :: ztra, zbtr, zdir, zdx, zdt, zmsk   ! local scalars
      REAL(wp), POINTER, DIMENSION(:,:,:) :: zfu, zfc, zfd, zwym
      !----------------------------------------------------------------------
      !
      CALL wrk_alloc( jpi, jpj, jpk, zfu, zfc, zfd, zwym )
      !
      !                                                          ! ===========
      DO jn = 1, kjpt                                            ! tracer loop
         !                                                       ! ===========
      ...
      END DO
      !
      CALL wrk_dealloc( jpi, jpj, jpk, zfu, zfc, zfd, zwym )
      !
