...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: traadv_ubs.F90 3787 2013-02-10 12:06:34Z gm $
...
CONTAINS
   ...
   SUBROUTINE tra_adv_ubs ( kt, kit000, cdtype, p2dt, pun, pvn, pwn,      &
      ...
      REAL(wp), POINTER, DIMENSION(:,:,:) :: ztu, ztv, zltu, zltv, zti, ztw, zwym
      !!----------------------------------------------------------------------
      !
      IF( nn_timing == 1 )  CALL timing_start('tra_adv_ubs')
      !
      CALL wrk_alloc( jpi, jpj, jpk, ztu, ztv, zltu, zltv, zti, ztw, zwym )
      !
      ...
      ENDDO
      !
      CALL wrk_dealloc( jpi, jpj, jpk, ztu, ztv, zltu, zltv, zti, ztw, zwym )
      !
